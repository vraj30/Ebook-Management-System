	...
	<div class="row">
		...
		<c:if test="${not empty userobj}">
			...
			<a href="checkout.jsp" class="mt-2"><i
					class="fa-solid fa-cart-shopping fa-2x mr-2"></i></a> 
				<a href="login.jsp" class="btn btn-success"><i
					class="fa-solid fa-user-plus"></i> ${userobj.user_name}</a> <a
		...
		<c:if test="${empty userobj}">
			...
			<a
					...
					class="fa-solid fa-arrow-right-from-bracket"></i> Register</a>
			</div>
		</c:if>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<!-- <button class="btn btn-light my-2 my-sm-0 ml-1" type="submit" onclick="helpline.jsp">
				<i class="fa-solid fa-mobile-screen-button"></i> Contact US
			</button> -->
		</form>
	</div>
</nav>